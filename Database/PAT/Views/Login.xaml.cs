...
namespace PAT.Views
{
    public partial class Login
    {
        ...
        private async void OnSubmitClicked(object sender, EventArgs e)
        {
            try
            {
                ...
                if (tutee != null)
                {
                    ...
                    App.ShellViewModel.IsTutor = false;
                ...
                if (tutor != null)
                {
                    ...
                    else
                    {
                        ...
                        App.ShellViewModel.IsLoggedIn = true;
                        App.ShellViewModel.IsTutor = true;
                        await Shell.Current.GoToAsync("//meetups");
                    }
        ...
        private async void NavToSignup(object? sender, EventArgs e) => await Shell.Current.GoToAsync("//signup");
    }
}